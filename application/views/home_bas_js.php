...
<?php if(in_array($page, array('home_user','home_historial','home_producto','home_compras','home_resumen','home_pagos_web','home_rent_client','home_activa','home_gest_empresas'))){?>
